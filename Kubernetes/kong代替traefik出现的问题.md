...
```bash
kubectl get service -n example-stage|grep mini
...
kubectl get deployment -n example-stage|grep mini
zz-miniapp-gateway        0/0     0            0           4d
 
kubectl get ingress -n example-stage|grep mini
NAME                           CLASS   HOSTS                             ADDRESS   PORTS   AGE
zz-miniapp-gateway-ingress     kong    miniapp-k8s01-stage.example.cn                80      5s
 
kubectl get ep -n example-stage|grep mini
NAME                                 ENDPOINTS               AGE
...
curl -XPOST -header -data https://miniapp-k8s01-stage.example.cn/miniapp/common/wechat/formid/getwechatsessionkey
